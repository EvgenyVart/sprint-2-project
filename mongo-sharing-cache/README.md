...
Запускаем mongodb в режиме шардирования 2 шарда, включены репликация и кэширования и приложение в одном инстансе
...
{_id: 1, host: "shard1_slave_1:27030"},
{_id: 2, host: "shard1_slave_2:27031"}
]})
```
Выход из консоли контейнера
```
...
{_id: 1, host: "shard2_slave_1:27040"},
{_id: 2, host: "shard2_slave_2:27041"}
]})
```
Выход из консоли контейнера
```
